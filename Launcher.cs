...
internal static class Program
{
    ...
    private static int Main(string[] args)
    {
        ...
        if (!File.Exists(tray))
        {
            ...
            {
                MessageBox.Show(
                    "DesktopIconTray.ps1 could not be unpacked. Download the zip from GitHub Releases and run Install.bat.",
                    "Desktop Icon Toggle",
    ...
    private static string UnpackOrFail(string[] args)
    {
        if (!HasEmbeddedResource("DesktopIconTray.ps1"))
        {
            MessageBox.Show(
                ...
                "Download the zip from GitHub Releases and run Install.bat:\n" +
